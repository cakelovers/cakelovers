    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-8 px-4 py-10">
      ...
      <div className="flex flex-col gap-8 text-sm leading-relaxed">
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">1. 수집하는 개인정보 항목</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">2. 개인정보의 수집 및 이용 목적</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">3. 개인정보의 보유 및 이용 기간</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">4. 개인정보 처리위탁</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">5. 이용자의 권리</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">6. 개인정보의 안전성 확보 조치</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold">7. 문의처</h2>
          <p>
