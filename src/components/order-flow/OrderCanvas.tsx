...
export function OrderCanvas({ compact = false, children }: OrderCanvasProps) {
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-[10px] bg-white shadow-[0_2px_4px_rgba(71,19,28,.06),0_20px_44px_rgba(71,19,28,.10)] transition-all duration-400 ease-[cubic-bezier(.22,1,.36,1)]",
        compact
